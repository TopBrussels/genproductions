...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/Unpart_ZTo2Mu_SU_0_dU_1p02_LU_15_8TeV_Tune4C_pythia8_cfi.py,v $'),
