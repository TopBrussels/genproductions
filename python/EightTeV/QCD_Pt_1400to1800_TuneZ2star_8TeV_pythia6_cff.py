...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_1400to1800_TuneZ2star_8TeV_pythia6_cff.py,v $'),
