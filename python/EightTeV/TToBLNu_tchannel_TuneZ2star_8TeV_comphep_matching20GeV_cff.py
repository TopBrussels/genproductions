...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/TToBLNu_tchannel_TuneZ2star_8TeV_comphep_matching20GeV_cff.py,v $'),
