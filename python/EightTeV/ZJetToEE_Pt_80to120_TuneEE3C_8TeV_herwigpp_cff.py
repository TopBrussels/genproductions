...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/ZJetToEE_Pt_80to120_TuneEE3C_8TeV_herwigpp_cff.py,v $'),
